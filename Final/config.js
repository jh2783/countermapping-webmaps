var config = {
    ...
    chapters: [
...

        {
            ...
            description: 'This long history of the Native American population’s spatial and social segregation in the matter of the national healthcare never ended. The inequality they experienced during European colonization still persists nowadays, driven by the government and the public’s disinterest. Compared to 8.7% of white population, the Native Americans❜ diabetes rate, 16%, is almost the double (Bryan, Molly, et al.) while cancer, alcoholism, storke, and depression rates are much higher than other race groups.  ',
            image2: 'https://github.com/jh2783/countermapping-webmaps/blob/main/Final/images/native%20ameircan%20disease.png?raw=true',
            location: {
                center: [-97.49355, 39.92230],
                zoom: 3.5,
                pitch: 0,
...

{
            ...
            description: 'Native Americans recorded the highest vaccination rate during the pandemic peak period in 2021. However, the vaccine did not guarantee the communities safety. Indeed, their hospitalization and death rates are the highest among other racial groups. What could cause this phenomenon? the </br> <br>description description</br> 1. ECONOMIC FACTOR: poverty 2. SOCIAL FACTOR: low internet access 3. PHYSICAL FACTOR: long travel distance to healthcare services',
            location: {
...

        {
            ...
            alignment: 'left',
            hidden: false,
            title: '1. COVID-19 as a Disease of Poverty? <br> ECONOMIC FACTOR: poverty',
            image: 'https://github.com/jh2783/countermapping-webmaps/blob/main/Final/images/Untitled-1.png?raw=true',
            description: 'description',
            image2: 'https://github.com/jh2783/countermapping-webmaps/blob/main/Final/images/Untitled-1.png?raw=true',
            location: {
                center: [-117.88655, 39.92230],
                zoom: 3.5,
                pitch: 0,
...

{
            ...
            description: 'description',
            image2:'https://github.com/jh2783/countermapping-webmaps/blob/main/Final/images/AP20130662205602-620x370.jpg?raw=true',
            location: {
...
bearing: 25.82
...

    {
            ...
            image: '',
            description: 'description',
            image2:'https://github.com/jh2783/countermapping-webmaps/blob/main/Final/images/At-Home-Covid19-Tests.jpg?raw=true',
            location: {
                center: [-117.88655, 39.92230],
                zoom: 3.5,
                pitch: 0,
...

    {
            ...
            image: 'https://github.com/jh2783/countermapping-webmaps/blob/main/Final/images/INTERNET.png?raw=true',
            description: 'description',
            image2: 'https://github.com/jh2783/countermapping-webmaps/blob/main/Final/images/BF01_RGBB-1.jpg?raw=true',
            location: {
...

{
            ...
            description: 'HISTORIC DISTRUST<br> description',
            location: {
...

{
            ...
            description: 'LACK OF INFRASTRUCTURE<br>description',
            location: {
